...
//teach-materlials1
    Route::get('lesson/teach-materlials1/0/1', 'LessonController@getMaterlials1_01');

    Route::get('lesson/teach-materlials1/0/2', 'LessonController@getMaterlials1_02');

    Route::get('lesson/teach-materlials1/0/3', 'LessonController@getMaterlials1_03');
