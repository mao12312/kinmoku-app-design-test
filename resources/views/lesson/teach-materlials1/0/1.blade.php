        ...
        <div class="container" data-sticky_parent>
            <div class="row">
                <div class=" col-lg-7 material_article">
                    ...
                    <img src="{{asset('/img1/1-img1.png')}}" alt="Instagramとは" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                    ...
                    <img src="{{asset('/img1/1-img2.png')}}" alt="Instagramとは" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                        ↑Instagramは世界で最も使われているSNSアプリの１つだ。</div>

                    <h4 id="2">Instagramのデザイン</h4>
                    <p>今回お話するのは <span>iOSアプリケーション</span> のInstagramのデザインです。</p>
                    <img src="{{asset('/img1/1-img3.png')}}" alt="Instagramとは" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                    ...
                    <img src="{{asset('/img1/1-img4.png')}}" alt="Instagramとは" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                    ...
                    <img src="{{asset('/img1/1-img5.png')}}" alt="Instagramとは" class="img-fluid box-shadow-blue">
                    <div class="img_text">
