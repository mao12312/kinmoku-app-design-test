            ...
            <div class="row">
                <div class=" col-lg-7 material_article">
                    ...
                    <p>今回は <span>iPhone8</span> でのUIデザインを作りましょう。そしてアートボードをはじめ、アイコンやロゴなどを管理して <span>UIデザインを作りやすい環境</span>
                        を作りましょう。</p>
                    <img src="{{asset('/img1/3-img1.png')}}" alt="AdobeXDにパーツを整理する" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                    ...
                    <img src="{{asset('/img1/3-img2.png')}}" alt="AdobeXDにパーツを整理する" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                    ...
                    <img src="{{asset('/img1/3-img3.png')}}" alt="AdobeXDにパーツを整理する" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                    ...
                    <img src="{{asset('/img1/3-img4.png')}}" alt="Instagramに必要な要素" class="img-fluid box-shadow-blue">
                    <div class="img_text">
                    ...
                    <div class="modal-content box-shadow-blue">
                        ...
                        <div class="modal-body">
                            <div class="text-center">
                                <img src="{{asset('/img1/success.svg')}}" alt="404の成功したよってアイコン" class="img-fluid box-shadow-blue">
                                <h4>Good job!!!</h4>
