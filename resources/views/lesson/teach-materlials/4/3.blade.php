                            ...
                            <div class="slider">
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                まずh4タグ、iタグそれぞれをactivities-partクラスのaタグの <span>ホバーアクション</span>
                                                としてつけましょう。今回はlinear-radientを使っているのでその場合colorで使えません。なので[ <span>-webkit-background-clip:
                                                    text; -webkit-text-fill-color: transparent;</span>
                                                ]をつけ、文字とアイコンにグラデーションをつけます。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド118.PNG" alt="" class="img-fluid slides-item1">
                                                    <div id="slides-modal1" class="iziModal" data-izimodal-title="ホバーアクション"
                                                        data-izimodal-subtitle="h4タグ、iタグそれぞれをactivities-partクラスのaタグのホバーアクションとしてつけましょう。">
                                                        <img src="/img/スライド118.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド119.PNG" alt="" class="img-fluid slides-item2">
                                                    <div id="slides-modal2" class="iziModal" data-izimodal-title="-webkit-background-clip:
                                                    text; -webkit-text-fill-color: transparent;"
                                                        data-izimodal-subtitle="文字とアイコンにグラデーションをつけます。">
                                                        <img src="/img/スライド119.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                これで1つのコラムが完了です！あとはこれをもう5個つくり、同じような配置になれば完成です！おめでとうございます！
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="/img/スライド120.PNG" alt="" class="img-fluid slides-item3">
                                                    <div id="slides-modal3" class="iziModal" data-izimodal-title="完成形！"
                                                        data-izimodal-subtitle="">
                                                        <img src="/img/スライド120.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>
                                自分でいろいろなホバーアクションを調べて装飾しても面白いです！あなただけのホバーアクションデザインを考えてみましょう。
                            </p>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="../5/1" class="btn cont_btn_mas_dets_second">次に進む</a>
                    </div>
                    <!-- modal footer content -->
                </div>
            </div>
