                            ...
                            <div class="slider">
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                これでシンプルな「 <span>学生に向けたポップなwebページ</span> 」を作ることができました！ですがまだ他のページも <span>レスポンシブデザイン</span>
                                                も <span>javascript</span> も <span>seo</span> の要素組み込めていません。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="/img/スライド193.PNG" alt="" class="img-fluid slides-item1">
                                                    <div id="slides-modal1" class="iziModal" data-izimodal-title="レスポンシブ"
                                                        data-izimodal-subtitle="スマホ画面で見るとこんな感じです">
                                                        <img src="/img/スライド193.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                近日それらも含めた教材を発表するので期待しておいてください！デザインで語る人になりましょう。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="/img/スライド194.PNG" alt="" class="img-fluid slides-item2">
                                                    <div id="slides-modal2" class="iziModal">
                                                        <img src="/img/スライド194.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>
                                to be design engineer. あなたの中のデザインの面白さを拡張できたなら嬉しいです。
                            </p>
                        </div>
                        <img src="{{asset('/img/popup11.jpeg')}}" class="img-fluid" alt="">
                    </div>
                    <!-- modal body content -->
