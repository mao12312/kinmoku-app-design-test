                            ...
                            <div class="slider">
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                中の要素が画面の右端、左端にあっては見にくく、 <span>UX</span> も高いとは言えません。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド56.PNG" alt="" class="img-fluid slides-item1">
                                                    <div id="slides-modal1" class="iziModal" data-izimodal-title="container"
                                                        data-izimodal-subtitle="containerがついていない時">
                                                        <img src="/img/スライド56.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド57.PNG" alt="" class="img-fluid slides-item2">
                                                    <div id="slides-modal2" class="iziModal" data-izimodal-title="container"
                                                        data-izimodal-subtitle="containerがついている時">
                                                        <img src="/img/スライド57.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                そこでヘッダーの一つ下のdivタグにBootstrapでおそらく最も使うといっても過言ではない「 <span>container</span> 」クラスを書き込みます。Containerクラスを用いることで要素の左右に <span>十分な余白</span> ができ、使いやすくなります。さらにこれからのページにすべてcontainerを用いることで「 <span>整列</span> 」がなされます。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド58.PNG" alt="" class="img-fluid slides-item3">
                                                    <div id="slides-modal3" class="iziModal" data-izimodal-title="Bootstrapとレスポンシブ">
                                                        <img src="/img/スライド58.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド59.PNG" alt="" class="img-fluid slides-item4">
                                                    <div id="slides-modal4" class="iziModal" data-izimodal-title="Bootstrapとレスポンシブ">
                                                        <img src="/img/スライド59.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="basicExampleModal">container</h5>
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>
                                containerを用いてページの左右の余白やデバイスに横幅も調節できます。
                            </p>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="../2/3" class="btn cont_btn_mas_dets_second">次に進む</a>
                    </div>
                    <!-- modal footer content -->
                </div>
            </div>
