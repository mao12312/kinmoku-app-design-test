                            ...
                            <div class="slider">
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                今回はオレンジをメインに使っていき、ライオンの画像と近い色を使用します。今回のページではこれらの色を使っていこうと思います。色は基本的にバラバラに多用するのではなく、一つ
                                                <span>メインカラー</span> を決め、その色に近い色を使用していきます。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="/img/スライド46.PNG" alt="" class="img-fluid slides-item1">
                                                    <div id="slides-modal1" class="iziModal" data-izimodal-title="色"
                                                        ...
                                                        <img src="/img/スライド46.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                今回は <span>グラデーション</span> を使用するので[linear-gradient(to right, #FFD200,
                                                #F7971E);]を用います。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="/img/スライド47.PNG" alt="" class="img-fluid slides-item3">
                                                    <div id="slides-modal3" class="iziModal" data-izimodal-title="グラデーション">
                                                        <img src="/img/スライド47.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="basicExampleModal">色</h5>
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>
                                色は文字だけでなく画像やページ自体にも印象をつけます。あなたのwebページの印象にあった色を選びましょう
                            </p>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="../1/7" class="btn cont_btn_mas_dets_second">次に進む</a>
                    </div>
                    <!-- modal footer content -->
                </div>
            </div>
