...
<body>
    ...
    {{--<nav class="navbar navbar-expand-lg navbar-light fixed-top">--}}
        {{--<a class="logomark" href="#">--}}
            {{--<img src="{{asset('/img/kinmoku-logo.svg')}}" alt="" class="logo">--}}
        {{--</a>--}}
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="{{asset('/img/スライド8.PNG')}}" alt="" class="img-fluid slides-item1">
                                                    <div id="slides-modal1" class="iziModal" data-izimodal-title="フォルダ"
                                                        data-izimodal-subtitle="フォルダはあなたの道具箱です。あなたの好きな名前をつける感覚で。">
                                                        <img src="{{asset('/img/スライド8.PNG')}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                        <img src="{{asset('/img/スライド9.PNG')}}" alt="" class="img-fluid slides-item2">
                                                    <div id="slides-modal2" class="iziModal" data-izimodal-title="フォルダを開く">
                                                        <img src="{{asset('/img/スライド9.PNG')}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="{{asset('/img/スライド10.PNG')}}" alt="" class="img-fluid slides-item3">
                                                    <div id="slides-modal3" class="iziModal" data-izimodal-title="2つのフォルダ"
                                                        ...
                                                        <img src="{{asset('/img/スライド10.PNG')}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="{{asset('/img/スライド11.PNG')}}" alt="" class="img-fluid slides-item4">
                                                    <div id="slides-modal4" class="iziModal" data-izimodal-title="自分で作るファイル"
                                                        ...
                                                        <img src="{{asset('/img/スライド11.PNG')}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="{{asset('/img/スライド12.PNG')}}" alt="" class="img-fluid slides-item5">
                                                    <div id="slides-modal5" class="iziModal" data-izimodal-title="ファイルの読み込み"
                                                        data-izimodal-subtitle="パスを間違えないように注意しましょう。">
                                                        <img src="{{asset('/img/スライド12.PNG')}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="{{asset('/img/スライド13.PNG')}}" alt="" class="img-fluid slides-item6">
                                                    <div id="slides-modal6" class="iziModal" data-izimodal-title="フォルダ"
                                                        data-izimodal-subtitle="フォルダはあなたの道具箱です。あなたの好きな名前をつける感覚で。">
                                                        <img src="{{asset('/img/スライド13.PNG')}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <img src="{{asset('/img/スライド14.PNG')}}" alt="" class="img-fluid slides-item7">
                                                    <div id="slides-modal7" class="iziModal" data-izimodal-title="フォルダを開く">
                                                        <img src="{{asset('/img/スライド14.PNG')}}" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
