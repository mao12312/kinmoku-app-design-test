                            ...
                            <div class="slider">
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                左の画像にはcol-md-6クラスのdivタグの中のimgタグにimg-fluidをつけます。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="/img/スライド125.PNG" alt="" class="img-fluid slides-item1">
                                                    <div id="slides-modal1" class="iziModal" data-izimodal-title="カラム"
                                                        data-izimodal-subtitle="左の画像にはcol-md-6クラスのdivタグの中のimgタグにimg-fluidをつけます。">
                                                        <img src="/img/スライド125.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                右のカラムはファーストビューとほとんど同じです。ただ左の画像との余白を設定する為に <span>col-md-5</span> としましょう。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド126.PNG" alt="" class="img-fluid slides-item2">
                                                    <div id="slides-modal2" class="iziModal" data-izimodal-title="右のカラムのhtml">
                                                        <img src="/img/スライド126.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド127.PNG" alt="" class="img-fluid slides-item3">
                                                    <div id="slides-modal3" class="iziModal" data-izimodal-title="右のカラムのcss"
                                                        data-izimodal-subtitle="">
                                                        <img src="/img/スライド127.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                最後にデザインの話で言うとこのセクションはheightが他のものに比べてコンパクトです。そのため画像を選ぶ際はあまり縦長の画像を選ばない方が良いです。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド128.PNG" alt="" class="img-fluid slides-item4">
                                                    <div id="slides-modal4" class="iziModal" data-izimodal-title="画像の選び方"
                                                        data-izimodal-subtitle="横長な画像だとセクションがコンパクトです">
                                                        <img src="/img/スライド128.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド129.PNG" alt="" class="img-fluid slides-item5">
                                                    <div id="slides-modal5" class="iziModal" data-izimodal-title="画像の選び方"
                                                        data-izimodal-subtitle="縦長だとコンパクトでないので読みにくいです。">
                                                        <img src="/img/スライド129.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- -------6------- -->
                                <div>
                                    <h3>おめでとうございます！<br>どんどん行きましょう！</h3>
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="basicExampleModal">About usのカラム</h5>
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>
                                画像は縦横比も大事だとわかってもらえたと思います。cssでいじればいいんですが、それよりも楽な画像の選定も一つの技術です。
                            </p>
                        </div>
                        <img src="{{asset('/img/popup6.jpeg')}}" class="img-fluid" alt="">
                    </div>
                    <!-- modal body content -->
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="../6/1" class="btn cont_btn_mas_dets_second">次に進む</a>
                    </div>
                    <!-- modal footer content -->
                </div>
            </div>
