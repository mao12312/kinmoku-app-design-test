                            ...
                            <div class="slider">
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                とてもきれいに整列された <span>グリッド</span> の表示です。とても組む機会が多いレイアウトで、この基礎的なレイアウトを身に着けておくと今後便利だと思います。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-lg-6">
                                                    <img src="/img/スライド137.PNG" alt="" class="img-fluid slides-item1">
                                                    <div id="slides-modal1" class="iziModal" data-izimodal-title="グリッド"
                                                        data-izimodal-subtitle="とてもきれいに整列されたグリッドの表示です。">
                                                        <img src="/img/スライド137.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 slides-text">
                                            <p>
                                                タイトルの構成はactivitiesのものとほぼ一緒です。タイトルの下にこれから作っていくグリッドとの間隔をあけるために <span>memberes-titl13</span> クラスでcssを書きましょう。
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slide-materials">
                                        <div class="slides-images">
                                            <div class="row justify-content-md-center">
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド138.PNG" alt="" class="img-fluid slides-item2">
                                                    <div id="slides-modal2" class="iziModal" data-izimodal-title="タイトルの構成" data-izimodal-subtitle="activitiesのものとほぼ一緒です。">
                                                        <img src="/img/スライド138.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <img src="/img/スライド139.PNG" alt="" class="img-fluid slides-item3">
                                                    <div id="slides-modal3" class="iziModal" data-izimodal-title="タイトルの構成のcss">
                                                        <img src="/img/スライド139.PNG" alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            ...
                            <p>
                                このグリッドのレイアウトはbootstrapのrowクラスの本領発揮ともいえます。頑張って覚えてしまいましょう！
                            </p>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="../7/2" class="btn cont_btn_mas_dets_second">次に進む</a>
                    </div>
                    <!-- modal footer content -->
                </div>
            </div>
